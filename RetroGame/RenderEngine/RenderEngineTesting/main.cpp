...
int main(void)
{
	...
	auto center = Rendering::TextBox((win.size / 2), Rendering::Interface::IMenu::Anchor::Center,&font, { 10, 10 });
	...
	sceneGraph.GetMenuManager()->menu_nodes.push_back(&fps_counter);
